...
### Added
* add robots.txt file for crawlers [#87](https://github.com/phisoft/feecollec-web/issues/87)
* add sitemap.xml file for better presence [#88](https://github.com/phisoft/feecollec-web/issues/88)
* add how it works for property owner [#82](https://github.com/phisoft/feecollec-web/issues/82)
...
### Updated
* Changelog
* update versioning on CHANGELOG.md
* Update description wording [#101](https://github.com/phisoft/feecollec-web/issues/101)
* fix ui how feecollec works [#93](https://github.com/phisoft/feecollec-web/issues/93)
* fix footer ui and ux [#96](https://github.com/phisoft/feecollec-web/issues/96)
* adjust wording size [#83](https://github.com/phisoft/feecollec-web/issues/83)
* fix feecollec spelling in website [#81](https://github.com/phisoft/feecollec-web/issues/81)
* Fix contact form fields [#78](https://github.com/phisoft/feecollec-web/issues/78)
* Fix spelling feecollec in section services [#76](https://github.com/phisoft/feecollec-web/issues/76)
* Update footer feecollec description [#74](https://github.com/phisoft/feecollec-web/issues/74)
...
### Changed
* change demo section UI [#95](https://github.com/phisoft/feecollec-web/issues/95)
* change layout for form section [#92](https://github.com/phisoft/feecollec-web/issues/92)
...
## Removed
* remove social media icons [#80](https://github.com/phisoft/feecollec-web/issues/80)
